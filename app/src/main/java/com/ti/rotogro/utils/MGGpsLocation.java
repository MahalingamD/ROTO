...
public class MGGpsLocation implements LocationListener {
    ...
    private static final long MIN_TIME_BW_UPDATES = 5 * 1000; // 30 minute
    ...
    public MGGpsLocation( FragmentActivity context) {
        this.mContext = context;
        getLocation();
    }

    public MGGpsLocation( Activity context) {
        this.mContext = context;
        getLocation();
    }
    ...
    public void stopUsingGPS() {
        try {
            if (locationManager != null) {
                locationManager.removeUpdates(MGGpsLocation.this);
            }
        } catch (SecurityException e) {
            e.printStackTrace();
        }
     ...
     * lauch Settings Options
     */
    public void showSettingsOneAlert() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(mContext);
